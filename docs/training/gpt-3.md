...
- **Understand the context:** [GPT-1](gpt-1.md) (the pre-train + fine-tune paradigm) · [GPT-2](gpt-2.md) (zero-shot transfer, WebText) · [The Transformer](../algorithms/transformer.md) (the architecture that made it possible) · Scaling Laws (Kaplan et al., the theoretical prediction GPT-3 confirmed)
