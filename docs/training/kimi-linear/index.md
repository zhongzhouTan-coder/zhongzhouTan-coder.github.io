...
- [DeepSeek-V4: Million-Token Hybrid Compressed Attention](../deepseek-v4/index.md) — another recent hybrid approach using CSA+HCA
- [SWAT: Sliding Window Attention Training](../swat-sliding-window-attention/index.md) — sigmoid-based sliding window alternative
- [MiniMax Sparse Attention](../minimax-sparse-attention/index.md) — block-sparse attention co-designed with GQA
