...
**Related pages:** [The Transformer](../algorithms/transformer.md) · [GPT-1](gpt-1.md) · [GPT-3](gpt-3.md) · [Training Index](index.md)
...
- **Understand the context:** [The Transformer](../algorithms/transformer.md) (the original architecture) · BERT (bidirectional pre-training, the competing paradigm) · Scaling Laws (Kaplan et al., the theoretical foundation for "bigger is better")
