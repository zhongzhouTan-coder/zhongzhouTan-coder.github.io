...
**Related pages:** [Kimi Linear](../kimi-linear/index.md), [Transformers Are RNNs: Linear Attention](../../algorithms/linear-attention/index.md), [SWAT](../swat-sliding-window-attention/index.md)
...
- **Build on:** [Kimi Linear](../kimi-linear/index.md) extends scalar decay to channel-wise Kimi Delta Attention.
