...
**Related pages:** [The Transformer](../algorithms/transformer.md) · [GPT-2](gpt-2.md) · [GPT-3](gpt-3.md) · [Training Index](index.md)
...
- **Understand the context:** [The Transformer](../algorithms/transformer.md) (the original encoder-decoder architecture) · BERT (bidirectional masked LM, the other branch of pre-training) · ELMo (contextual RNN embeddings, the approach GPT-1 superseded)
