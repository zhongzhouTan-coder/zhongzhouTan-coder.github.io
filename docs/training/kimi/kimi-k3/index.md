...
**Related pages:** [Kimi Linear](../kimi-linear/index.md), [DeepSeek-V4](../../deepseek/deepseek-v4/index.md), [DeepSeek-V3.2](../../../algorithms/deepseek-v3.2/index.md), [MiniMax Sparse Attention](../../efficient-attention/minimax-sparse-attention/index.md), [Megatron-LM](../../parallelism/megatron-lm/index.md)
...
- **Build on:** [Kimi Linear](../kimi-linear/index.md) for the underlying KDA/MLA hybrid; [Megatron-LM](../../parallelism/megatron-lm/index.md) for large-scale training parallelism.
- **Understand the context:** [DeepSeek-V4](../../deepseek/deepseek-v4/index.md) for a contrasting million-token architecture; [DeepSeek-V3.2](../../../algorithms/deepseek-v3.2/index.md) for sparse attention plus scaled RL; [MiniMax Sparse Attention](../../efficient-attention/minimax-sparse-attention/index.md) for another long-context efficiency route.
