...
- [Kimi Linear: Expressive Efficient Attention Architecture](kimi-linear/index.md) — Hybrid [linear attention](../../terms/linear-attention.md): [KDA](../../terms/kimi-delta-attention.md) with channel-wise gating extends Gated DeltaNet, 3:1 KDA-to-MLA layer ratio with NoPE, 48B [MoE](../../terms/mixture-of-experts.md) (3B active); for the first time outperforms full attention across short/long/RL regimes, 6.3× decoding speedup at 1M context.
