...
**Related pages:** [The Transformer](../../algorithms/foundations/transformer.md) · [GPT-1](gpt-1.md) · [GPT-2](gpt-2.md) · [GPT-3](gpt-3.md) · [Training Index](../index.md)
...
- **Understand the context:** [GPT-3](gpt-3.md) for in-context learning at 175B parameters · [The Transformer](../../algorithms/foundations/transformer.md) for the base architecture · [GPT-2](gpt-2.md) for zero-shot prompt transfer
