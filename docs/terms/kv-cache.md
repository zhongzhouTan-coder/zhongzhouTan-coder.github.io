...
- [YOCO: You Only Cache Once](../training/efficient-attention/yoco/index.md) — Separates a bounded-memory self-decoder from cross-decoder layers that all reuse one global KV cache.
