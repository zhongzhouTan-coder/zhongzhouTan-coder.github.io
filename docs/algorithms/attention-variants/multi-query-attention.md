...
**Related pages:** [The Transformer](../foundations/transformer.md) · [Collaborative Multi-Head Attention](collaborative-attention.md) · [Grouped-Query Attention in Llama 2](grouped-query-attention/../index.md) · [DeepSeek-V2 Multi-Head Latent Attention](deepseek-v2-mla.md) · [Algorithms Index](../index.md)
...
- The original Transformer paper ["Attention Is All You Need"](../foundations/transformer.md) — for full background on multi-head attention.
