...
- [Grouped-Query Attention in Llama 2](grouped-query-attention/index.md) — Llama 2's 34B/70B GQA decision: 8 KV groups, 30B MHA/MQA/GQA ablation, higher large-batch throughput, and simpler 8-GPU tensor-parallel serving than MQA. <!-- termlint-ignore: grouped-query-attention -- Navigation label already links the dedicated GQA insight. -->
