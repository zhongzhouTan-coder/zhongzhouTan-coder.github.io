...
- [DeepSeek-V2 Multi-Head Latent Attention](deepseek-v2-mla.md) — DeepSeek-V2's MLA design: low-rank joint K/V latent cache, decoupled RoPE, query compression, MoE serving context, 93.3% KV-cache reduction, and 5.76× maximum generation throughput versus DeepSeek 67B.
