...
- [FlashAttention-3: Hopper Asynchrony and FP8 Attention](flashattention-3.md) — Hopper attention kernel design: warp specialization, TMA/WGMMA asynchrony, [GEMM](../../terms/gemm.md)-softmax overlap, FP8 block quantization, incoherent processing, and speed/accuracy results.
