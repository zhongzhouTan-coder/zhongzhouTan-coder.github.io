...
Compared with [vLLM](../../frameworks/vllm/vllm-framework.md), FA4 is a lower-level attention-kernel algorithm. vLLM manages KV-cache memory and serving throughput at the system level, while FA4 optimizes the exact attention forward/backward kernels themselves.
