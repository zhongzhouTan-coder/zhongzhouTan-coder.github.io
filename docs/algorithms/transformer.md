...
**Related pages:** [Collaborative Multi-Head Attention](collaborative-attention.md) · [FlashAttention](flashattention.md) · [Softmax](softmax.md) · [vLLM Framework](../frameworks/vllm-framework.md)
...
- **Understand the context:** [Collaborative Multi-Head Attention](collaborative-attention.md) (head redundancy) · [FlashAttention](flashattention.md) (IO-aware attention) · [Softmax](softmax.md) (the attention nonlinearity) · [vLLM Framework](../frameworks/vllm-framework.md) (Transformer serving with PagedAttention)
