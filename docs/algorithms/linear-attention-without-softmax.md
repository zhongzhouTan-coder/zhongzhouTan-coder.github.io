...
**Related pages:** [Recurrent Neural Networks](recurrent-neural-networks/index.md), [The Transformer](transformer.md), [Linear Attention (Transformers Are RNNs)](linear-attention/index.md), [The Softmax Function](softmax.md), [Linear Attention term](../terms/linear-attention.md)
