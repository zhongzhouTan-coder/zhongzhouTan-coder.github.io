...
**Related pages:** [Kimi K3](../training/kimi-k3/index.md), [Kimi Delta Attention](../terms/kimi-delta-attention.md), [Mixture of Experts](../terms/mixture-of-experts.md), [vLLM-Ascend Kimi K3 MoE Forward Path](vllm-ascend-kimi-k3-moe-forward.md), [vLLM Code Learning Path](vllm-code-learning-path.md)
