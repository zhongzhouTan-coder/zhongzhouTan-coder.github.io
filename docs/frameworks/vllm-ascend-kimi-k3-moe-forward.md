...
**Related pages:** [Kimi K3](../training/kimi-k3/index.md), [vLLM Kimi K3 Code Reading Map](vllm-kimi-k3-code-reading.md), [Mixture of Experts](../terms/mixture-of-experts.md), [DeepSeek V4 Attention Code Reading](deepseek-v4-attention-code-reading.md), [Triton in vLLM/vllm-ascend](triton-language/triton-in-vllm.md)
...
- [Kimi K3](../training/kimi-k3/index.md) for the model architecture.
- [vLLM Kimi K3 Code Reading Map](vllm-kimi-k3-code-reading.md) for upstream model code.
...
- [Triton in vLLM/vllm-ascend](triton-language/triton-in-vllm.md) for the plugin's Triton and custom-kernel surface.
