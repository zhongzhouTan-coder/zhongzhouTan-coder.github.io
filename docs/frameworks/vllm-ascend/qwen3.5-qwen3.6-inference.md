...
7. **MoE experts (35B-A3B only).** The sparse-MoE variant routes tokens through Ascend routed experts (FusedMoE) under `--enable-expert-parallel`, enabled by the `qwen3_5_moe` packed-module layout.
