---
kind: web-extraction
source_url: "https://nvidia.github.io/TransformerEngine/features/low_precision_training/nvfp4/nvfp4.html"
final_url: "https://nvidia.github.io/TransformerEngine/features/low_precision_training/nvfp4/nvfp4.html"
canonical_url: "https://nvidia.github.io/TransformerEngine/features/low_precision_training/nvfp4/nvfp4.html"
title: "NVFP4 — Transformer Engine 2.19.0.dev0 documentation"
author: ""
published_at: ""
captured_at: "2026-07-28T07:33:23.583Z"
content_sha256: 6625830e9e9ee594d10067a0b433c6a1dff08c40ed8c66c9b7c7addd07c74284
renderer: http
extractor: "defuddle@0.13.0 + turndown@7.2.4"
assets:
  - "derived/web-markdown/hardware/nvfp4-te--web-2026-07-28-6625830e9e9e.assets/inline-01-fe2d80fb0cb6.svg"
  - "derived/web-markdown/hardware/nvfp4-te--web-2026-07-28-6625830e9e9e.assets/inline-02-970dc2770035.svg"
  - "derived/web-markdown/hardware/nvfp4-te--web-2026-07-28-6625830e9e9e.assets/inline-03-d716b9d750f4.svg"
  - "derived/web-markdown/hardware/nvfp4-te--web-2026-07-28-6625830e9e9e.assets/inline-04-1ec34dd4f0de.svg"
  - "derived/web-markdown/hardware/nvfp4-te--web-2026-07-28-6625830e9e9e.assets/inline-05-a67fcb721022.svg"
  - "derived/web-markdown/hardware/nvfp4-te--web-2026-07-28-6625830e9e9e.assets/inline-06-959f130fbc21.svg"
---
...
![Figure 1. Bit layout comparison between standard FP8 formats (E4M3 and E5M2) and NVFP4 (E2M1).](nvfp4-te--web-2026-07-28-6625830e9e9e.assets/inline-01-fe2d80fb0cb6.svg)
...
![Figure 2. NVFP4 hierarchical scaling structure showing the combination of block-level and global scaling factors.](nvfp4-te--web-2026-07-28-6625830e9e9e.assets/inline-02-970dc2770035.svg)
...
![Figure 3. Stochastic rounding illustration. Given a value x to be quantized, and the two nearest representable NVFP4 values v1 (lower) and v2 (higher), deterministic rounding always rounds to the nearest value, while stochastic rounding...](nvfp4-te--web-2026-07-28-6625830e9e9e.assets/inline-03-d716b9d750f4.svg)
...
![Figure 4. WGRAD GEMM pipeline comparison: without RHT (left) and with RHT applied (right).](nvfp4-te--web-2026-07-28-6625830e9e9e.assets/inline-04-1ec34dd4f0de.svg)
...
Like [MXFP8](https://nvidia.github.io/TransformerEngine/features/low_precision_training/mxfp8/mxfp8.html), NVFP4 requires both rowwise and columnwise quantized tensors for different GEMM operands. Unlike MXFP8 which supports multiple layouts (TN, NT, NN), **NVFP4 GEMM only supports the TN layout**.
...
![Figure 5. NVFP4 rowwise vs columnwise quantization layout. Unlike MXFP8, columnwise scales are stored transposed.](nvfp4-te--web-2026-07-28-6625830e9e9e.assets/inline-05-a67fcb721022.svg)
...
![Figure 6. Quantization and all-gather flow for NVFP4 showing amax synchronization and hierarchical scaling.](nvfp4-te--web-2026-07-28-6625830e9e9e.assets/inline-06-959f130fbc21.svg)
...
NVFP4 requires swizzling of block scaling factors (`s_block`) before GEMM operations, similar to [MXFP8](https://nvidia.github.io/TransformerEngine/features/low_precision_training/mxfp8/mxfp8.html). Key differences:
