---
kind: web-extraction
source_url: "https://pytorch.org/blog/accelerating-pytorch-with-cuda-graphs/"
final_url: "https://pytorch.org/blog/accelerating-pytorch-with-cuda-graphs/"
canonical_url: "https://pytorch.org/blog/accelerating-pytorch-with-cuda-graphs/"
title: "Accelerating PyTorch with CUDA Graphs – PyTorch"
author: "By Vinh Nguyen, Michael Carilli, Sukru Burc Eryilmaz, Vartika Singh, Michelle Lin, Natalia Gimelshein, Alban Desmaison, Edward Yang"
published_at: ""
captured_at: "2026-08-10T09:07:24.838Z"
content_sha256: ad0c8a15d55eedc5a21ed2de60a90e0951cac920d48afc65c2413bba79610e42
renderer: http
...
![Image](https://pytorch.org/wp-content/uploads/2024/11/cudagraphs-pytorch.png)
...
![Cuda graphs reduce launching overhead by bundling multiple GPU operations into a single launchable unit, i.e., a graph. On the top, you can see five individual launches; whereas on the bottom, with CUDA graphs, they are all bundled into...](https://pytorch.org/assets/images/cuda-image-2.png)  
Figure 1. Benefits of using CUDA graphs
...
![With NCCL CUDA graph support, all the kernel launches for NCCL AllReduce for the forward/backward propagation can be bundled into a graph to reduce overhead launch time.](https://pytorch.org/assets/images/cuda-image-3.png)  
...
![NSight timeline plot of Mask R-CNN shows that the CPU is maxed out at 100% load while GPU is idle most of the time, and a lot of empty space between GPU kernels](https://pytorch.org/assets/images/cuda-image-4.png)  
...
![With CUDA graph, the entire graph is launched with a single op, eliminating all the CPU overhead](https://pytorch.org/assets/images/cuda-image-5.png)  
...
![Synchronization free training eliminates CPU synchronization](https://pytorch.org/assets/images/cuda-image-6.png)  
...
![CUDA graphs optimization for the DLRM model. The impact is larger for smaller batch sizes where CPU overheads are more pronounced.](https://pytorch.org/wp-content/uploads/2024/11/cuda-image-7.png)
...
![CUDA graphs optimization for the DLRM model. The impact is larger for smaller batch sizes where CPU overheads are more pronounced.](https://pytorch.org/assets/images/cuda-image-8.png)  
...
We thank many NVIDIAN’s and Facebook engineers for their discussions and suggestions: [Karthik Mandakolathur US](mailto:karthik@nvidia.com), [Tomasz Grel](mailto:tgrel@nvidia.com), [PLJoey Conway](mailto:jconway@nvidia.com), [Arslan Zulfiqar US](mailto:azulfiqar@nvidia.com)

Authors bios
------------

[**Vinh Nguyen**](mailto:vinhn@nvidia.com) *DL Engineer, NVIDIA*
...
[**Michael Carilli**](mailto:mcarilli@nvidia.com) *Senior Developer Technology Engineer, NVIDIA*
...
[**Sukru Burc Eryilmaz**](mailto:seryilmaz@nvidia.com) *Senior Architect in Dev Arch, NVIDIA*
...
[**Vartika Singh**](mailto:vartikas@nvidia.com) *Tech Partner Lead for DL Frameworks and Libraries, NVIDIA*
...
[**Michelle Lin**](mailto:miclin@nvidia.com) *Product Intern, NVIDIA*
...
[**Natalia Gimelshein**](mailto:ngimel@fb.com) *Applied Research Scientist, Facebook*
...
[**Alban Desmaison**](mailto:albandes@fb.com) *Research Engineer, Facebook*
...
[**Edward Yang**](mailto:ezyang@fb.com) *Research Engineer, Facebook*
