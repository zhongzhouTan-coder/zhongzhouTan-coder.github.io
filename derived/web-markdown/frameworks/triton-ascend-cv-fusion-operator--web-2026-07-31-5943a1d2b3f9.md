---
kind: web-extraction
source_url: "https://triton-ascend.readthedocs.io/zh-cn/latest/programming_guide/cv_fusion_operator.html"
final_url: "https://triton-ascend.readthedocs.io/zh-cn/latest/programming_guide/cv_fusion_operator.html"
canonical_url: "https://triton-ascend.readthedocs.io/zh-cn/latest/programming_guide/cv_fusion_operator.html"
title: "CV 融合算子开发 - Triton Ascend latest 文档"
author: ""
published_at: ""
captured_at: "2026-07-31T06:04:58.837Z"
content_sha256: 5943a1d2b3f9299f2c0a16a98799bf304c5e930581699b5b2b48fad4f360e545
renderer: http
...
简单 CV 融合建议先从本仓 [矩阵乘法样例](https://triton-ascend.readthedocs.io/zh-cn/latest/examples/05_matrix_multiplication_example.html) 抽出稳定的 `tl.dot` 主计算，再在写回前加入 Vector 后处理；更复杂的切片更新可参考 [融合注意力样例](https://triton-ascend.readthedocs.io/zh-cn/latest/examples/04_fused_attention_example.html) 。最小路径如下：
...
对于 attention 类 CV 融合，推荐先让非 causal、短序列、小 head\_dim 的 case 跑通，再逐步加入：
...
-   HEAD\_DIM 较大时的 accumulator workspace 和子块切分。
