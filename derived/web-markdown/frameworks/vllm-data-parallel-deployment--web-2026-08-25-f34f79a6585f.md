---
kind: web-extraction
source_url: "https://docs.vllm.ai/en/latest/serving/data_parallel_deployment/"
final_url: "https://docs.vllm.ai/en/latest/serving/data_parallel_deployment/"
canonical_url: "https://docs.vllm.ai/en/latest/serving/data_parallel_deployment/"
title: "Data Parallel Deployment - vLLM"
author: ""
published_at: ""
captured_at: "2026-08-25T03:29:57.151Z"
content_sha256: f34f79a6585f09dac6c9406a493f5da0530600f06a6e993d7eef5d00f2b3aea9
renderer: http
extractor: "defuddle@0.13.0 + turndown@7.2.4"
---

[](https://github.com/vllm-project/vllm/edit/main/docs/serving/data_parallel_deployment.md "Edit this page")
...
By default, expert layers form a tensor parallel group of size `DP × TP`. To use expert parallelism instead, include the `--enable-expert-parallel` CLI arg (on all nodes in the multi-node case). See [Expert Parallel Deployment](https://docs.vllm.ai/en/latest/serving/expert_parallel_deployment/) for details on how attention and expert layers behave differently with EP enabled.
...
This document focuses on online deployments (with the API server). DP + EP is also supported for offline usage (via the LLM class), for an example see [examples/features/data\_parallel/data\_parallel\_offline.py](https://github.com/vllm-project/vllm/blob/main/examples/features/data_parallel/data_parallel_offline.py).
...
![DP Internal LB Diagram](https://docs.vllm.ai/en/latest/assets/deployment/dp_internal_lb.png)
...
![DP External LB Diagram](https://docs.vllm.ai/en/latest/assets/deployment/dp_external_lb.png)
