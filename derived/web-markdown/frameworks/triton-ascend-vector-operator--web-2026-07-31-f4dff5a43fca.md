---
kind: web-extraction
source_url: "https://triton-ascend.readthedocs.io/zh-cn/latest/programming_guide/vector_operator.html"
final_url: "https://triton-ascend.readthedocs.io/zh-cn/latest/programming_guide/vector_operator.html"
canonical_url: "https://triton-ascend.readthedocs.io/zh-cn/latest/programming_guide/vector_operator.html"
title: "Vector 算子开发 - Triton Ascend latest 文档"
author: ""
published_at: ""
captured_at: "2026-07-31T06:04:53.347Z"
content_sha256: f4dff5a43fca259c9a7cb33eb3bf85b79d5154e8c427ebda15d6a9b8f8ac26e1
renderer: http
...
简单 Vector 算子可以从本仓的 [向量相加样例](https://triton-ascend.readthedocs.io/zh-cn/latest/examples/01_vector_add_example.html) 或 `third_party/ascend/tutorials/01-vector-add.py` 入手。该类算子的基本步骤如下：
...
-   **BLOCK\_SIZE** ：BLOCK\_SIZE 需要在 UB 容量内尽量大。若出现 UB overflow，先降低单次处理元素数，再考虑拆分子块。
...
-   [`tutorial/best_practice/004-gather_scatter.py`](https://github.com/Ascend/triton-ascend-ops/blob/main/tutorial/best_practice/004-gather_scatter.py) ：Megablocks gather/scatter/scatter\_wgrad 的 Ascend 亲和实现。
