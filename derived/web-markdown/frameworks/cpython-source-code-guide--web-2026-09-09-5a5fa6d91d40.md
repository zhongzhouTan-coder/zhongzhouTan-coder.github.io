---
kind: web-extraction
source_url: "https://realpython.com/cpython-source-code-guide/"
final_url: "https://realpython.com/cpython-source-code-guide/"
canonical_url: "https://realpython.com/cpython-source-code-guide/"
title: "Your Guide to the CPython Source Code"
author: "Real Python"
published_at: "2019-08-21T14:00:00+00:00"
captured_at: "2026-09-09T09:28:05.252Z"
content_sha256: 5a5fa6d91d401a149f5eda4aa2460ea328d15613641f8c8ab7c9aa9eddac03f9
renderer: local-html
...
-   [Learn Python](#)
    ...
    [Your Learning Plan →Your personalized Python learning plan](https://realpython.com/account/learning-plan/) [Python Tutorials →In-depth articles and video courses](https://realpython.com/search?kind=article&kind=course&order=newest) [Learning Paths →Guided study plans for accelerated learning](https://realpython.com/learning-paths/)
...
-   [Sign‑In](https://realpython.com/account/login/?intent=navbar&next=%2Fcpython-source-code-guide%2F)
...
[Browse Topics](https://realpython.com/tutorials/all/) [Guided Learning Paths](https://realpython.com/learning-paths/)  
[Basics](https://realpython.com/search?level=basics) [Intermediate](https://realpython.com/search?level=intermediate) [Advanced](https://realpython.com/search?level=advanced)
...
![Image](https://img.realpython.net/21855bda3ff8f87b19d280bc237f4b83)

[Table of Contents](#toc)

-   [Part 1: Introduction to CPython](#part-1-introduction-to-cpython)
    -   [What’s in the Source Code?](#whats-in-the-source-code)
    -   [Compiling CPython (macOS)](#compiling-cpython-macos)
    -   [Compiling CPython (Linux)](#compiling-cpython-linux)
    -   [Compiling CPython (Windows)](#compiling-cpython-windows)
    ...
    -   [The Python Language Specification](#the-python-language-specification)
    -   [Memory Management in CPython](#memory-management-in-cpython)
    -   [Conclusion](#conclusion)
-   [Part 2: The Python Interpreter Process](#part-2-the-python-interpreter-process)
    -   [Establishing Runtime Configuration](#establishing-runtime-configuration)
    -   [Reading Files/Input](#reading-filesinput)
    -   [Lexing and Parsing](#lexing-and-parsing)
    -   [Abstract Syntax Trees](#abstract-syntax-trees)
    -   [Conclusion](#conclusion_1)
-   [Part 3: The CPython Compiler and Execution Loop](#part-3-the-cpython-compiler-and-execution-loop)
    -   [Compiling](#compiling)
    -   [Execution](#execution)
    -   [Conclusion](#conclusion_3)
-   [Part 4: Objects in CPython](#part-4-objects-in-cpython)
    -   [Base Object Type](#base-object-type)
    -   [The Bool and Long Integer Type](#the-bool-and-long-integer-type)
    -   [A Review of the Generator Type](#a-review-of-the-generator-type)
    -   [Conclusion](#conclusion_4)
-   [Part 5: The CPython Standard Library](#part-5-the-cpython-standard-library)
    -   [Python Modules](#python-modules)
    -   [Python and C Modules](#python-and-c-modules)
    -   [The CPython Regression Test Suite](#the-cpython-regression-test-suite)
    -   [Installing a Custom Version](#installing-a-custom-version)
-   [The CPython Source Code: Conclusion](#the-cpython-source-code-conclusion)

Mark as Completed

[](https://realpython.com/feedback/survey/article/cpython-source-code-guide/liked/?from=article-sidebar "Liked it")[](https://realpython.com/feedback/survey/article/cpython-source-code-guide/disliked/?from=article-sidebar "Disliked it")

Share

![Image](https://img.realpython.net/609393a03ca1e3437385150e8a1a022e)

![Your Guide to the CPython Source Code](https://files.realpython.com/media/A-Tourist-Guide-to-the-CPython-Source-Code_Watermarked.5f05a87331ac.jpg)

Your Guide to the CPython Source Code
=====================================

by [Anthony Shaw](#author) Updated Aug 21, 2019 Reading time estimate 2h 12m [19 Comments](#reader-comments) [advanced](https://realpython.com/tutorials/advanced/) [python](https://realpython.com/tutorials/python/)
...
![Image](https://img.realpython.net/16bf1efe41b538fae54711c58c701f0e)

[Remove ads](https://realpython.com/account/join/)

Are there certain parts of Python that just seem magic? Like how are [dictionaries](https://realpython.com/python-dicts/) so much faster than looping over a list to find an item. How does a generator remember the state of the variables each time it yields a value and why do you never have to allocate memory like other languages? It turns out, CPython, the most popular Python [runtime](https://realpython.com/ref/computer-science-glossary/runtime/) is written in human-readable [C](https://realpython.com/c-for-python-programmers/) and Python code. This tutorial will walk you through the CPython source code.
...
**Free Download:** [Get a sample chapter from CPython Internals: Your Guide to the Python 3 Interpreter](https://realpython.com/bonus/cpython-internals-sample/) showing you how to unlock the inner workings of the Python language, compile the Python interpreter from source code, and participate in the development of CPython.

**Take the Quiz:** Test your knowledge with our interactive “Your Guide to the CPython Source Code” quiz. You’ll receive a score upon completion to help you track your learning progress:
...
](https://realpython.com/quizzes/cpython-source-code-guide/)

**Interactive Quiz**

[Your Guide to the CPython Source Code](https://realpython.com/quizzes/cpython-source-code-guide/)
...
Part 1: Introduction to CPython[](#part-1-introduction-to-cpython "Permanent link")
-----------------------------------------------------------------------------------

When you type `python` at the console or install a Python distribution from [python.org](https://www.python.org/), you are running **CPython**. CPython is one of the many Python runtimes, maintained and written by different teams of developers. Some other runtimes you may have heard are [PyPy](https://pypy.org/), [Cython](https://cython.org/), and [Jython](https://www.jython.org/).
...
The Python language specification is the document that the description of the Python language. For example, it says that `assert` is a [reserved keyword](https://realpython.com/python-keywords/), and that `[]` is used for indexing, slicing, and creating empty lists.
...
![Image](https://img.realpython.net/fc3dcce3b30783158d89077cf5a8810e)

[Remove ads](https://realpython.com/account/join/)

### What’s in the Source Code?[](#whats-in-the-source-code "Permanent link")
...
To download a copy of the CPython source code, you can use [`git`](https://realpython.com/python-git-github-intro/) to pull the latest version to a working copy locally:

Language: Shell

`$ git clone https://github.com/python/cpython $ cd cpython $ git checkout v3.8.0b4`

**Note:** If you don’t have Git available, you can download the source in a [ZIP](https://github.com/python/cpython/archive/v3.8.0b4.zip) file directly from the GitHub website.
...
### Compiling CPython (macOS)[](#compiling-cpython-macos "Permanent link")
...
You will also need a working copy of [OpenSSL](https://www.openssl.org/) to use for fetching packages from the PyPi.org website. If you later plan on using this build to install additional packages, SSL validation is required.

The simplest way to install OpenSSL on macOS is by using [HomeBrew](https://brew.sh/). If you already have HomeBrew installed, you can install the dependencies for CPython with the `brew install` command:
...
`$ ./python.exe Python 3.8.0b4 (tags/v3.8.0b4:d93605de72, Aug 30 2019, 10:00:03)  [Clang 10.0.1 (clang-1001.0.46.4)] on darwin Type "help", "copyright", "credits" or "license" for more information. >>>` 
...
![Image](https://img.realpython.net/e8b8e877da2a454b3a6930fecd28c95c)

[Remove ads](https://realpython.com/account/join/)

### Compiling CPython (Linux)[](#compiling-cpython-linux "Permanent link")
...
During the build, you may receive some errors, and in the summary, it will notify you that not all packages could be built. That’s okay if you aren’t planning on developing against those packages. If you are, then check out the [dev guide](https://devguide.python.org/) website for more information.
...
`$ ./python Python 3.8.0b4 (tags/v3.8.0b4:d93605de72, Aug 30 2019, 10:00:03)  [Clang 10.0.1 (clang-1001.0.46.4)] on darwin Type "help", "copyright", "credits" or "license" for more information. >>>` 

### Compiling CPython (Windows)[](#compiling-cpython-windows "Permanent link")
...
None of the paid features are required for compiling CPython or this tutorial. You can use the Community edition of Visual Studio, which is available for free from [Microsoft’s Visual Studio website](https://visualstudio.microsoft.com/vs/).
...
[![Visual Studio Options Window](https://files.realpython.com/media/Screen_Shot_2019-08-22_at_2.47.23_pm.5e8682a89503.png)](https://files.realpython.com/media/Screen_Shot_2019-08-22_at_2.47.23_pm.5e8682a89503.png)
...
[![Choosing a Project Type in Visual Studio](https://files.realpython.com/media/Capture3.e19765d74ec4.PNG)](https://files.realpython.com/media/Capture3.e19765d74ec4.PNG)

For the project URL, type `https://github.com/python/cpython` to clone:

[![Cloning projects in Visual Studio](https://files.realpython.com/media/Capture4.ea01418a971c.PNG)](https://files.realpython.com/media/Capture4.ea01418a971c.PNG)
...
[![Selecting a solution](https://files.realpython.com/media/Capture6.3d06a62b8e87.PNG)](https://files.realpython.com/media/Capture6.3d06a62b8e87.PNG)
...
Once this is complete, you need to download some source files to be able to build the whole CPython package. Inside the `PCBuild` folder there is a `.bat` file that automates this for you. [Open up a command-line prompt inside](https://www.youtube.com/watch?v=bgSSJQolR0E) the downloaded `PCBuild` and run `get_externals.bat`:

Language: Shell

 `> get_externals.bat Using py -3.7 (found 3.7 with py.exe) Fetching external libraries... Fetching bzip2-1.0.6... Fetching sqlite-3.21.0.0... Fetching xz-5.2.2... Fetching zlib-1.2.11... Fetching external binaries... Fetching openssl-bin-1.1.0j... Fetching tcltk-8.6.9.0... Finished.`
...
[![CPython debugging Windows](https://files.realpython.com/media/Capture8.967a3606daf0.PNG)](https://files.realpython.com/media/Capture8.967a3606daf0.PNG)
...
[![Choosing Python environments](https://files.realpython.com/media/Environments.96a819ecf0b3.png)](https://files.realpython.com/media/Environments.96a819ecf0b3.png)
...
[![Adding an environment in VS2019](https://files.realpython.com/media/environment3.d33858c1f6aa.PNG)](https://files.realpython.com/media/environment3.d33858c1f6aa.PNG)
...
[![Python Environment REPL](https://files.realpython.com/media/environment4.7c9eade3b74e.PNG)](https://files.realpython.com/media/environment4.7c9eade3b74e.PNG)
...
[![Switching Environment Mode](https://files.realpython.com/media/environments5.6462694398e3.6fb872a5f57d.png)](https://files.realpython.com/media/environments5.6462694398e3.6fb872a5f57d.png)

Now you have a version of CPython compiled and ready to go, let’s find out how the CPython compiler works.

![Image](https://img.realpython.net/913fd28f526ec8aca047551bce4892b6)

[Remove ads](https://realpython.com/account/join/)

### What Does a Compiler Do?[](#what-does-a-compiler-do "Permanent link")
...
### Why Is CPython Written in C and Not Python?[](#why-is-cpython-written-in-c-and-not-python "Permanent link")
...
There is a Python compiler written in Python called [PyPy](https://realpython.com/pypy-faster-python/). [PyPy](https://realpython.com/ref/glossary/pypy/)’s logo is an [Ouroboros](https://en.wikipedia.org/wiki/Ouroboros) to represent the self-hosting nature of the compiler.
...
### The Python Language Specification[](#the-python-language-specification "Permanent link")
...
Inside `compound_stmts.rst`, the documentation for compound statements, you can see a simple example defining the [`with` statement](https://realpython.com/python-with-statement/).
...
#### Grammar[](#grammar "Permanent link")
...
The Grammar file is written in a context-notation called [Backus-Naur Form (BNF)](https://en.m.wikipedia.org/wiki/Backus%E2%80%93Naur_form). BNF is not specific to Python and is often used as the notation for grammars in many other languages.
...
#### Using `pgen`[](#using-pgen "Permanent link")
...
To see `pgen` in action, let’s change part of the Python grammar. Around line 51 you will see the definition of a [`pass` statement](https://realpython.com/python-pass/):
...
Now you need to rebuild the grammar files. On macOS and Linux, run `make regen-grammar` to run `pgen` over the altered grammar file. For Windows, run `build.bat --regen` from within the `PCBuild` directory.
...
`# Regenerate Doc/library/token-list.inc from Grammar/Tokens # using Tools/scripts/generate_token.py ... python3 ./Tools/scripts/update_file.py ./Include/graminit.h ./Include/graminit.h.new python3 ./Tools/scripts/update_file.py ./Python/graminit.c ./Python/graminit.c.new`
...
`Python 3.8.0b4 (tags/v3.8.0b4:d93605de72, Aug 30 2019, 10:00:03)  [Clang 10.0.1 (clang-1001.0.46.4)] on darwin Type "help", "copyright", "credits" or "license" for more information. >>> def example(): ...    proceed ...  >>> example()`
...
`$ ./python.exe -d test_tokens.py  Token NAME/'def' ... It's a keyword  DFA 'file_input', state 0: Push 'stmt'  DFA 'stmt', state 0: Push 'compound_stmt'  DFA 'compound_stmt', state 0: Push 'funcdef'  DFA 'funcdef', state 0: Shift. Token NAME/'my_function' ... It's a token we know  DFA 'funcdef', state 1: Shift. Token LPAR/'(' ... It's a token we know  DFA 'funcdef', state 2: Push 'parameters'  DFA 'parameters', state 0: Shift. Token RPAR/')' ... It's a token we know  DFA 'parameters', state 1: Shift.   DFA 'parameters', state 2: Direct pop. Token COLON/':' ... It's a token we know  DFA 'funcdef', state 3: Shift. Token NEWLINE/'' ... It's a token we know  DFA 'funcdef', state 5: [switch func_body_suite to suite] Push 'suite'  DFA 'suite', state 0: Shift. Token INDENT/'' ... It's a token we know  DFA 'suite', state 1: Shift. Token NAME/'proceed' ... It's a keyword  DFA 'suite', state 3: Push 'stmt' ...   ACCEPT.`
...
![Image](https://img.realpython.net/39d33f31dff9ce5e91d62b0a7b0c7420)

[Remove ads](https://realpython.com/account/join/)

### Memory Management in CPython[](#memory-management-in-cpython "Permanent link")
...
#### Reference Counting[](#reference-counting "Permanent link")
...
References to an object are decremented when a variable falls outside of the scope in which it was declared. Scope in Python can refer to a function or method, a comprehension, or a [lambda function](https://realpython.com/python-lambda/). These are some of the more literal scopes, but there are many other implicit scopes, like passing variables to a function call.
...
#### Garbage Collection[](#garbage-collection "Permanent link")
...
![Image](https://img.realpython.net/8c80de229a52f9edcdfefa85a454bbbe)
...
Part 2: The Python Interpreter Process[](#part-2-the-python-interpreter-process "Permanent link")
-------------------------------------------------------------------------------------------------
...
### Establishing Runtime Configuration[](#establishing-runtime-configuration "Permanent link")
...
![Image](https://img.realpython.net/80e19a8924e33dc994db2b63586bc3fc)

[Remove ads](https://realpython.com/account/join/)

### Reading Files/Input[](#reading-filesinput "Permanent link")
...
#### Input via `-c`[](#input-via-c "Permanent link")
...
[![Flow chart of pymain_run_command](https://files.realpython.com/media/pymain_run_command.f5da561ba7d5.png)](https://files.realpython.com/media/pymain_run_command.f5da561ba7d5.png)

First, the [`pymain_run_command()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Modules/main.c#L240) function is executed inside `Modules/main.c` taking the command passed in `-c` as an argument in the C type `wchar_t*`. The `wchar_t*` type is often used as a low-level storage type for [Unicode](https://realpython.com/python-encodings-guide/) data across CPython as the size of the type can store UTF8 characters.

When converting the `wchar_t*` to a Python string, the `Objects/unicodeobject.c` file has a helper function [`PyUnicode_FromWideChar()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Objects/unicodeobject.c#L2088) that returns a `PyObject`, of type `str`. The encoding to UTF-8 is then done by `PyUnicode_AsUTF8String()` on the Python `str` object to convert it to a Python [`bytes` object](https://realpython.com/python-bytes/).
...
#### Input via `-m`[](#input-via-m "Permanent link")
...
#### Input via Filename[](#input-via-filename "Permanent link")
...
#### Input via File With `PyRun_FileExFlags()`[](#input-via-file-with-pyrun_fileexflags "Permanent link")
...
#### Input via Compiled Bytecode With `run_pyc_file()`[](#input-via-compiled-bytecode-with-run_pyc_file "Permanent link")
...
![Image](https://img.realpython.net/681db5178e811f0240f3775742f6b3b9)

[Remove ads](https://realpython.com/account/join/)

### Lexing and Parsing[](#lexing-and-parsing "Permanent link")
...
To make it easier to understand, you can take all the numbers in the `symbol` and `token` modules, put them into a dictionary and [recursively](https://realpython.com/python-thinking-recursively/) replace the values in the output of `parser.st2list()` with the names:
...
![Image](https://img.realpython.net/6f3ee504e80b141bffc9616003e3fff6)

[Remove ads](https://realpython.com/account/join/)

### Abstract Syntax Trees[](#abstract-syntax-trees "Permanent link")
...
`>>> import instaviz >>> def example():        a = 1        b = a + 1        return b  >>> instaviz.show(example)`
...
[![Instaviz screenshot](https://files.realpython.com/media/screenshot.e148c89e3a9a.png)](https://files.realpython.com/media/screenshot.e148c89e3a9a.png)
...
[![Instaviz screenshot 3](https://files.realpython.com/media/Screen_Shot_2019-03-19_at_1.24.37_pm.21a11b49a820.png)](https://files.realpython.com/media/Screen_Shot_2019-03-19_at_1.24.37_pm.21a11b49a820.png)
...
Looking at [`PyAST_FromNodeObject()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Python/ast.c#L772) you can see that it is essentially a `switch` statement around the result from `TYPE(n)`. `TYPE()` is one of the core functions used by the AST to determine what type a node in the concrete syntax tree is. In the case of [`PyAST_FromNodeObject()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Python/ast.c#L772) it’s just looking at the first node, so it can only be one of the module types defined as `Module`, `Interactive`, `Expression`, `FunctionType`.

The result of `TYPE()` will be either a symbol or token type, which we’re very familiar with by this stage.

For `file_input`, the results should be a `Module`. Modules are a series of statements, of which there are a few types. The logic to traverse the children of `n` and create statement nodes is within [`ast_for_stmt()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Python/ast.c#L4512). This function is called either once, if there is only 1 statement in the module, or in a loop if there are many. The resulting `Module` is then returned with the `PyArena`.

For `eval_input`, the result should be an `Expression`. The result from `CHILD(n ,0)`, which is the first child of `n` is passed to [`ast_for_testlist()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Python/ast.c#L3246) which returns an `expr_ty` type. This `expr_ty` is sent to `Expression()` with the PyArena to create an expression node, and then passed back as a result:
...
Inside the [`ast_for_stmt()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Python/ast.c#L4512) function, there is another `switch` statement for each possible statement type (`simple_stmt`, `compound_stmt`, and so on) and the code to determine the arguments to the node class.

One of the simpler functions is for the power expression, i.e., `2**4` is 2 to the power of 4. This function starts by getting the [`ast_for_atom_expr()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Python/ast.c#L2770), which is the number `2` in our example, then if that has one child, it returns the atomic expression. If it has more than one child, it will get the right-hand (the number `4`) and return a `BinOp` (binary operation) with the operator as `Pow` (power), the left hand of `e` (2), and the right hand of `f` (4):
...
[![Instaviz screenshot 4](https://files.realpython.com/media/Screen_Shot_2019-03-19_at_5.34.51_pm.c3a1e8d717f5.png)](https://files.realpython.com/media/Screen_Shot_2019-03-19_at_5.34.51_pm.c3a1e8d717f5.png)

In the UI you can also see the corresponding properties:

[![Instaviz screenshot 5](https://files.realpython.com/media/Screen_Shot_2019-03-19_at_5.36.34_pm.0067235460de.png)](https://files.realpython.com/media/Screen_Shot_2019-03-19_at_5.36.34_pm.0067235460de.png)
...
![Image](https://img.realpython.net/6ffb9d655931714d22f6f628f1dd999c)

[Remove ads](https://realpython.com/account/join/)

### Conclusion[](#conclusion_1 "Permanent link")
...
Part 3: The CPython Compiler and Execution Loop[](#part-3-the-cpython-compiler-and-execution-loop "Permanent link")
-------------------------------------------------------------------------------------------------------------------
...
### Compiling[](#compiling "Permanent link")
...
#### Future Flags and Compiler Flags[](#future-flags-and-compiler-flags "Permanent link")
...
#### Symbol Tables[](#symbol-tables "Permanent link")
...
Some of the symbol table API is exposed via [the `symtable` module](https://docs.python.org/3/library/symtable.html) in the standard library. You can provide an expression or a module an receive a `symtable.SymbolTable` instance.
...
`>>> import symtable >>> s = symtable.symtable('b + 1', filename='test.py', compile_type='eval') >>> [symbol.__dict__ for symbol in s.get_symbols()] [{'_Symbol__name': 'b', '_Symbol__flags': 6160, '_Symbol__scope': 3, '_Symbol__namespaces': ()}]`
...
Remember, `mod_ty` is an AST instance, so the will now [recursively](https://realpython.com/python-recursion/) explore the nodes and branches of the tree and add entries to the symtable:
...
**Note:** If you’ve ever wondered why Python’s default arguments are mutable, the reason is in this function. You can see they are a pointer to the variable in the symtable. No extra work is done to copy any values to an [immutable](https://realpython.com/courses/immutability-python/) type.
...
#### Core Compilation Process[](#core-compilation-process "Permanent link")
...
`for i in iterable:     # block else:  # optional if iterable is False     # block`
...
Many of the statements can have sub-statements. A [`for` loop](https://realpython.com/python-for-loop/) has a body, but you can also have complex expressions in the assignment and the iterator.
...
#### Assembly[](#assembly "Permanent link")
...
-   Ensure that every block that falls off the end returns `None`, this is why every function returns `None`, whether or not a [`return` statement](https://realpython.com/python-return-statement/) exists
...
`static void dfs(struct compiler *c, basicblock *b, struct assembler *a, int end) {     int i, j;      /* Get rid of recursion for normal control flow.        Since the number of blocks is limited, unused space in a_postorder        (from a_nblocks to end) can be used as a stack for still not ordered        blocks. */     for (j = end; b && !b->b_seen; b = b->b_next) {         b->b_seen = 1;         assert(a->a_nblocks < j);         a->a_postorder[--j] = b;     }     while (j < end) {         b = a->a_postorder[j++];         for (i = 0; i < b->b_iused; i++) {             struct instr *instr = &b->b_instr[i];             if (instr->i_jrel || instr->i_jabs)                 dfs(c, instr->i_target, a, j);         }         assert(a->a_nblocks < j);         a->a_postorder[a->a_nblocks++] = b;     } }`

#### Creating a Code Object[](#creating-a-code-object "Permanent link")
...
[![PyCodeObject structure](https://files.realpython.com/media/codeobject.9c054576627c.png)](https://files.realpython.com/media/codeobject.9c054576627c.png)
...
You may also notice that the bytecode is sent to [`PyCode_Optimize()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Python/peephole.c#L230) before it is sent to [`PyCode_NewWithPosOnlyArgs()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Objects/codeobject.c#L106). This function is part of the bytecode optimization process in `Python/peephole.c`.
...
#### Conclusion[](#conclusion_2 "Permanent link")

We can pull together all of these stages with the instaviz module:

Language: Python

`import instaviz  def foo():     a = 2**4     b = 1 + 5     c = [1, 4, 6]     for i in c:         print(i)     else:         print(a)     return c  instaviz.show(foo)`

Will produce an AST graph:

[![Instaviz screenshot 6](https://files.realpython.com/media/Screen_Shot_2019-03-20_at_3.18.32_pm.4d9a0ea827ff.png)](https://files.realpython.com/media/Screen_Shot_2019-03-20_at_3.18.32_pm.4d9a0ea827ff.png)

With bytecode instructions in sequence:

[![Instaviz screenshot 7](https://files.realpython.com/media/Screen_Shot_2019-03-20_at_3.17.54_pm.6ea8ea532015.png)](https://files.realpython.com/media/Screen_Shot_2019-03-20_at_3.17.54_pm.6ea8ea532015.png)

Also, the code object with the variable names, constants, and binary `co_code`:

[![Instaviz screenshot 8](https://files.realpython.com/media/Screen_Shot_2019-03-20_at_3.17.41_pm.231a0678f142.png)](https://files.realpython.com/media/Screen_Shot_2019-03-20_at_3.17.41_pm.231a0678f142.png)

![Image](https://img.realpython.net/28d978cf3e7797b78e9cba11b65bc2c6)
...
[`PyEval_EvalCode()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Python/ceval.c#L716) is the public API for evaluating a code object. The logic for evaluation is split between [`_PyEval_EvalCodeWithName()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Python/ceval.c#L4045) and [`_PyEval_EvalFrameDefault()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Python/ceval.c#L745), which are both in `ceval.c`.

The public API [`PyEval_EvalCode()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Python/ceval.c#L716) will construct an execution frame from the top of the stack by calling [`_PyEval_EvalCodeWithName()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Python/ceval.c#L4045).

The construction of the first execution frame has many steps:

1.  Keyword and positional arguments are resolved.
2.  The use of [`*args` and `**kwargs`](https://realpython.com/python-kwargs-and-args/) in function definitions are resolved.
3.  Arguments are added as local variables to the scope.
4.  Co-routines and [Generators](https://realpython.com/introduction-to-python-generators/) are created, including the Asynchronous Generators.

The frame object looks like this:

[![PyFrameObject structure](https://files.realpython.com/media/PyFrameObject.8616eee0503e.png)](https://files.realpython.com/media/PyFrameObject.8616eee0503e.png)

Let’s step through those sequences.

#### 1\. Constructing Thread State[](#1-constructing-thread-state "Permanent link")

Before a frame can be executed, it needs to be referenced from a thread. CPython can have many threads running at any one time within a single interpreter. An Interpreter state includes a list of those threads as a linked list. The thread structure is called [`PyThreadState`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Include/pystate.h#L23), and there are many references throughout `ceval.c`.

Here is the structure of the thread state object:

[![PyThreadState structure](https://files.realpython.com/media/PyThreadState.20467f3689b7.png)](https://files.realpython.com/media/PyThreadState.20467f3689b7.png)

#### 2\. Constructing Frames[](#2-constructing-frames "Permanent link")

The input to [`PyEval_EvalCode()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Python/ceval.c#L716) and therefore [`_PyEval_EvalCodeWithName()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Python/ceval.c#L4045) has arguments for:
...
#### 3\. Converting Keyword Parameters to a Dictionary[](#3-converting-keyword-parameters-to-a-dictionary "Permanent link")
...
`def example(arg, arg2=None, **kwargs):     print(kwargs['extra'])  # this would resolve to a dictionary key`

The logic for creating a keyword argument dictionary is in the next part of [\_PyEval\_EvalCodeWithName()](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Python/ceval.c#L4045):
...
#### 4\. Converting Positional Arguments Into Variables[](#4-converting-positional-arguments-into-variables "Permanent link")
...
At the end of the loop, you’ll see a call to [`SETLOCAL()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Python/ceval.c#L1005) with the value, so if a positional argument is defined with a value, that is available within this scope:

Language: Python

`def example(arg1, arg2):     print(arg1, arg2)  # both args are already local variables.`
...
#### 5\. Packing Positional Arguments Into `*args`[](#5-packing-positional-arguments-into-args "Permanent link")
...
#### 6\. Loading Keyword Arguments[](#6-loading-keyword-arguments "Permanent link")
...
`>>> def my_function(a, b, c=None, d=None, **remaining):        print(a, b, c, d, remaining)  >>> my_function(a=1, b=2, c=3, d=4, e=5) (1, 2, 3, 4, {'e': 5})`

**Positional-only arguments** is a new feature in Python 3.8. Introduced in [PEP570](https://www.python.org/dev/peps/pep-0570/), positional-only arguments are a way of stopping users of your API from using positional arguments with a keyword syntax.
...
`def to_celcius(farenheit, /, options=None):     return (farenheit-31)*5/9`
...
`>>> to_celcius(farenheit=110) Traceback (most recent call last):   File "<stdin>", line 1, in <module> TypeError: to_celcius() got some positional-only arguments passed as keyword arguments: 'farenheit'`

The resolution of the keyword argument dictionary values comes after the unpacking of all other arguments. The PEP570 positional-only arguments are shown by starting the keyword-argument loop at `co_posonlyargcount`. If the `/` symbol was used on the 3rd argument, the value of `co_posonlyargcount` would be `2`. `PyDict_SetItem()` is called for each remaining argument to add it to the `locals` dictionary, so when executing, each of the keyword arguments are scoped local variables:

Language: C

    `for (i = 0; i < kwcount; i += kwstep) {         PyObject **co_varnames;         PyObject *keyword = kwnames[i];         PyObject *value = kwargs[i];         ...          /* Speed hack: do raw pointer compares. As names are            normally interned this should almost always hit. */         co_varnames = ((PyTupleObject *)(co->co_varnames))->ob_item;         for (j = co->co_posonlyargcount; j < total_args; j++) {            PyObject *name = co_varnames[j];             if (name == keyword) {                 goto kw_found;             }         }          if (kwdict == NULL) {              if (co->co_posonlyargcount                 && positional_only_passed_as_keyword(tstate, co,                                                      kwcount, kwnames))             {                 goto fail;             }              _PyErr_Format(tstate, PyExc_TypeError,                           "%U() got an unexpected keyword argument '%S'",                           co->co_name, keyword);             goto fail;         }          if (PyDict_SetItem(kwdict, keyword, value) == -1) {             goto fail;         }         continue;        kw_found:         ...         Py_INCREF(value);         SETLOCAL(j, value);     }     ...`

At the end of the loop, you’ll see a call to [`SETLOCAL()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Python/ceval.c#L1005) with the value. If a keyword argument is defined with a value, that is available within this scope:

Language: Python

`def example(arg1, arg2, example_kwarg=None):     print(example_kwarg)  # example_kwarg is already a local variable.`

#### 7\. Adding Missing Positional Arguments[](#7-adding-missing-positional-arguments "Permanent link")
...
#### 8\. Adding Missing Keyword Arguments[](#8-adding-missing-keyword-arguments "Permanent link")
...
#### 9\. Collapsing Closures[](#9-collapsing-closures "Permanent link")
...
#### 10\. Creating Generators, Coroutines, and Asynchronous Generators[](#10-creating-generators-coroutines-and-asynchronous-generators "Permanent link")

If the evaluated code object has a flag that it is a [generator](https://realpython.com/courses/python-generators/), coroutine or async generator, then a new frame is created using one of the unique methods in the Generator, Coroutine or Async libraries and the current frame is added as a property.
...
Language: C
    ...
    `/* Handle generator/coroutine/asynchronous generator */     if (co->co_flags & (CO_GENERATOR | CO_COROUTINE | CO_ASYNC_GENERATOR)) {         ...          /* Create a new generator that owns the ready to run frame          * and return that as the value. */         if (is_coro) {             gen = PyCoro_New(f, name, qualname);         } else if (co->co_flags & CO_ASYNC_GENERATOR) {             gen = PyAsyncGen_New(f, name, qualname);         } else {             gen = PyGen_NewWithQualName(f, name, qualname);         }         ...          return gen;     }`

Lastly, [`PyEval_EvalFrameEx()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Python/ceval.c#L738) is called with the new frame:

Language: C

    `retval = PyEval_EvalFrameEx(f,0);     ... }`

#### Frame Execution[](#frame-execution "Permanent link")
...
The local and global variables are determined at runtime based on how that function, module, or block was called. This information is added to the frame by the [`_PyEval_EvalCodeWithName()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Python/ceval.c#L4045) function. There are other usages of frames, like the coroutine decorator, which dynamically generates a frame with the target as a variable.

The public API, [`PyEval_EvalFrameEx()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Python/ceval.c#L738) calls the interpreter’s configured frame evaluation function in the `eval_frame` property. Frame evaluation was [made pluggable in Python 3.7 with PEP 523](https://www.python.org/dev/peps/pep-0523/).

[`_PyEval_EvalFrameDefault()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Python/ceval.c#L745) is the default function, and it is unusual to use anything other than this.

Frames are executed in the main execution loop inside [`_PyEval_EvalFrameDefault()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Python/ceval.c#L745). This function is central function that brings everything together and brings your code to life. It contains decades of optimization since even a single line of code can have a significant impact on performance for the whole of CPython.
...
Alternatively, [Visual Studio Code](https://realpython.com/python-development-visual-studio-code/) can do inline macro expansion once you have installed the official C/C++ extension:

[![C Macro expansion with VScode](https://files.realpython.com/media/Screen_Shot_2019-03-25_at_3.33.40_pm.c240b1a46e99.png)](https://files.realpython.com/media/Screen_Shot_2019-03-25_at_3.33.40_pm.c240b1a46e99.png)
...
`import sys import dis import traceback import io  def trace(frame, event, args):    frame.f_trace_opcodes = True    stack = traceback.extract_stack(frame)    pad = "   "*len(stack) + "|"    if event == 'opcode':       with io.StringIO() as out:          dis.disco(frame.f_code, frame.f_lasti, file=out)          lines = out.getvalue().split('\n')          [print(f"{pad}{l}") for l in lines]    elif event == 'call':       print(f"{pad}Calling {frame.f_code}")    elif event == 'return':       print(f"{pad}Returning {args}")    elif event == 'line':       print(f"{pad}Changing line to {frame.f_lineno}")    else:       print(f"{pad}{frame} ({event} - {args})")    print(f"{pad}----------------------------------")    return trace sys.settrace(trace)  # Run some code for a demo eval('"-".join([letter for letter in "hello"])')`
...
[![Evaluating frame with tracing](https://files.realpython.com/media/Screen_Shot_2019-03-25_at_1.21.07_pm.7b03e9032f62.png)](https://files.realpython.com/media/Screen_Shot_2019-03-25_at_1.21.07_pm.7b03e9032f62.png)

The full list of instructions is available on the [`dis` module](https://docs.python.org/3/library/dis.html#python-bytecode-instructions) documentation.

#### The Value Stack[](#the-value-stack "Permanent link")
...
[![PUSH()](https://files.realpython.com/media/stacks_push.0c755d83b347.png)](https://files.realpython.com/media/stacks_push.0c755d83b347.png)
...
[![POP()](https://files.realpython.com/media/stacks_pop.85872baaa8c3.png)](https://files.realpython.com/media/stacks_pop.85872baaa8c3.png)
...
[![PUSH();PUSH()](https://files.realpython.com/media/stacks_pushpush.e052996db029.png)](https://files.realpython.com/media/stacks_pushpush.e052996db029.png)

If you were to fetch the top value in the stack, you would get a pointer to `b` because it is at the top:

[![POP();](https://files.realpython.com/media/stacks_pop2.af5068718f92.png)](https://files.realpython.com/media/stacks_pop2.af5068718f92.png)
...
[![PEEK()](https://files.realpython.com/media/stacks_peek.b00bde86bc7b.png)](https://files.realpython.com/media/stacks_peek.b00bde86bc7b.png)
...
[![DUP_TOP()](https://files.realpython.com/media/stacks_duptop.9b2eafe67375.png)](https://files.realpython.com/media/stacks_duptop.9b2eafe67375.png)

There is a rotation macro `ROT_TWO` that swaps the first and second values:

[![ROT_TWO()](https://files.realpython.com/media/stacks_rottwo.2990d9b3ecc7.png)](https://files.realpython.com/media/stacks_rottwo.2990d9b3ecc7.png)

Each of the opcodes have a predefined “stack effect,” calculated by the [`stack_effect()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Python/compile.c#L878) function inside `Python/compile.c`. This function returns the delta in the number of values inside the stack for each opcode.

#### Example: Adding an Item to a List[](#example-adding-an-item-to-a-list "Permanent link")
...
Language: C
 ...
 `...      case TARGET(LOAD_FAST): {         PyObject *value = GETLOCAL(oparg);                 // 1.         if (value == NULL) {             format_exc_check_arg(                 PyExc_UnboundLocalError,                 UNBOUNDLOCAL_ERROR_MSG,                 PyTuple_GetItem(co->co_varnames, oparg));             goto error;                                    // 2.         }         Py_INCREF(value);                                  // 3.         PUSH(value);                                       // 4.         FAST_DISPATCH();                                   // 5.     }  ...`
...
Then the C API for Python lists is called for [`list`](https://realpython.com/python-list/) and `v`. The code for this is inside `Objects/listobject.c`, which we go into in the next chapter.
...
`def function2():   raise RuntimeError  def function1():   function2()  if __name__ == '__main__':   function1()`

Calling this on the command line will give you:

Language: Shell

`$ ./python.exe example_stack.py  Traceback (most recent call last):   File "example_stack.py", line 8, in <module>     function1()   File "example_stack.py", line 5, in function1     function2()   File "example_stack.py", line 2, in function2     raise RuntimeError RuntimeError`
...
[![Example frame stack](https://files.realpython.com/media/Frame_Stack_Example.20728854763c.png)](https://files.realpython.com/media/Frame_Stack_Example.20728854763c.png)

### Conclusion[](#conclusion_3 "Permanent link")
...
Part 4: Objects in CPython[](#part-4-objects-in-cpython "Permanent link")
-------------------------------------------------------------------------
...
Because C is not object-oriented [like Python](https://realpython.com/python3-object-oriented-programming/), objects in C don’t inherit from one another. `PyObject` is the data structure for the beginning of the Python object’s memory.

Much of the base object API is declared in `Objects/object.c`, like the function [`PyObject_Repr`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Objects/object.c#L505), which the built-in `repr()` function. You will also find [`PyObject_Hash()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Objects/object.c#L810) and other APIs.

All of these functions can be overridden in a custom object by implementing “dunder” methods on a Python object:

Language: Python

`class MyObject(object):      def __init__(self, id, name):         self.id = id         self.name = name      def __repr__(self):         return "<{0} id={1}>".format(self.name, self.id)`

This code is implemented in [`PyObject_Repr()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Objects/object.c#L505), inside `Objects/object.c`. The type of the target object, `v` will be inferred through a call to [`Py_TYPE()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Include/object.h#L122) and if the `tp_repr` field is set, then the function pointer is called. If the `tp_repr` field is not set, i.e. the object doesn’t declare a custom `__repr__` method, then the default behavior is run, which is to return `"<%s object at %p>"` with the type name and the ID:
...
The ob\_type field for a given `PyObject*` will point to the data structure `PyTypeObject`, defined in `Include/cpython/object.h`. This data-structure lists all the built-in functions, as fields and the arguments they should receive.
...
`typedef struct {     lenfunc sq_length; // len(v)     binaryfunc sq_concat; // v + x     ssizeargfunc sq_repeat; // for x in v     ssizeargfunc sq_item; // v[x]     void *was_sq_slice; // v[x:y:z]     ssizeobjargproc sq_ass_item; // v[x] = z     void *was_sq_ass_slice; // v[x:y] = z     objobjproc sq_contains; // x in v      binaryfunc sq_inplace_concat;     ssizeargfunc sq_inplace_repeat; } PySequenceMethods;`

All of these built-in functions are called the [Python Data Model](https://docs.python.org/3/reference/datamodel.html). One of the great resources for the Python Data Model is [“Fluent Python” by Luciano Ramalho](https://www.oreilly.com/library/view/fluent-python/9781491946237/).

### Base Object Type[](#base-object-type "Permanent link")
...
-   `Objects/structseq.c` for a [`struct.Struct`](https://docs.python.org/3/library/struct.html#struct.Struct) type
-   `Objects/tupleobject.c` for a `tuple` type
-   `Objects/typeobject.c` for a `type` type
-   `Objects/unicodeobject.c` for a `str` type
-   `Objects/weakrefobject.c` for a [`weakref` object](https://docs.python.org/3/library/weakref.html)
...
### The Bool and Long Integer Type[](#the-bool-and-long-integer-type "Permanent link")

The `bool` type is the most straightforward implementation of the built-in types. It inherits from `long` and has the predefined constants, [`Py_True`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Include/boolobject.h#L22) and [`Py_False`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Include/boolobject.h#L21). These constants are immutable instances, created on the instantiation of the Python interpreter.
...
Memory is allocated to a new `long` through [`_PyLong_New()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Objects/longobject.c#L262). This function takes a fixed length and makes sure it is smaller than `MAX_LONG_DIGITS`. Then it reallocates the memory for `ob_digit` to match the length.
...
To convert a [double-point floating point](https://en.wikipedia.org/wiki/Double-precision_floating-point_format) to a Python `long`, `PyLong_FromDouble()` does the math for you:
...
The remainder of the implementation functions in `longobject.c` have utilities, such as converting a [Unicode string](https://realpython.com/python-sort-unicode-strings/) into a number with [`PyLong_FromUnicodeObject()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Objects/longobject.c#L2672).

### A Review of the Generator Type[](#a-review-of-the-generator-type "Permanent link")

[Python Generators](https://realpython.com/introduction-to-python-generators/) are functions which return a `yield` statement and can be called continually to generate further values.
...
`>>> def example(): ...   lst = [1,2,3,4] ...   for i in lst: ...     yield i ...  >>> gen = example() >>> gen <generator object example at 0x100bcc480>`
...
[![Structure of generator types](https://files.realpython.com/media/generators.536b1404195a.png)](https://files.realpython.com/media/generators.536b1404195a.png)
...
The coroutine and [async generators](https://realpython.com/async-io-python/#other-features-async-for-and-async-generators-comprehensions) have the same fields but prepended with `cr` and `ag` respectively.

If you call `__next__()` on the generator object, the next value is yielded until eventually a `StopIteration` is raised:

Language: Python

`>>> gen.__next__() 1 >>> gen.__next__() 2 >>> gen.__next__() 3 >>> gen.__next__() 4 >>> gen.__next__() Traceback (most recent call last):   File "<stdin>", line 1, in <module> StopIteration`
...
Whenever `__next__()` is called on a generator object, [`gen_iternext()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Objects/genobject.c#L541) is called with the generator instance, which immediately calls [`gen_send_ex()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Objects/genobject.c#L153) inside `Objects/genobject.c`.
...
`PyGen_NewWithQualName()` will call [`gen_new_with_qualname()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Objects/genobject.c#L778) with the generated frame and then create the `PyGenObject` with `NULL` values and the compiled code object:
...
### Conclusion[](#conclusion_4 "Permanent link")
...
Some libraries have types written in C instead of inheriting from the built-in types. One example is `numpy`, a library for numeric arrays. The [`nparray`](https://docs.scipy.org/doc/numpy/reference/generated/numpy.array.html) type is written in C, is highly efficient and performant.

In the next Part, we will explore the classes and functions defined in the standard library.

Part 5: The CPython Standard Library[](#part-5-the-cpython-standard-library "Permanent link")
---------------------------------------------------------------------------------------------
...
### Python Modules[](#python-modules "Permanent link")
...
`>>> import colorsys >>> colorsys <module 'colorsys' from '/usr/shared/lib/python3.7/colorsys.py'>  >>> colorsys.rgb_to_hls(255,0,0) (0.0, 127.5, -1.007905138339921)` 

We can see the source code of `rgb_to_hls()` inside `Lib/colorsys.py`:

Language: Python

`# HLS: Hue, Luminance, Saturation # H: position in the spectrum # L: color lightness # S: color saturation  def rgb_to_hls(r, g, b):     maxc = max(r, g, b)     minc = min(r, g, b)     # XXX Can optimize (maxc+minc) and (maxc-minc)     l = (minc+maxc)/2.0     if minc == maxc:         return 0.0, l, 0.0     if l <= 0.5:         s = (maxc-minc) / (maxc+minc)     else:         s = (maxc-minc) / (2.0-maxc-minc)     rc = (maxc-r) / (maxc-minc)     gc = (maxc-g) / (maxc-minc)     bc = (maxc-b) / (maxc-minc)     if r == maxc:         h = bc-gc     elif g == maxc:         h = 2.0+rc-bc     else:         h = 4.0+gc-rc     h = (h/6.0) % 1.0     return h, l, s`

There’s nothing special about this function, it’s just standard Python. You’ll find similar things with all of the pure Python standard library modules. They’re just written in plain Python, well laid out and easy to understand. You may even spot improvements or bugs, so you can make changes to them and [contribute it to the Python distribution](https://realpython.com/start-contributing-python/). We’ll cover that toward the end of this article.

### Python and C Modules[](#python-and-c-modules "Permanent link")
...
Python will `import * from __builtins__` when an interpreter is instantiated, so all of the functions like [`print()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Python/bltinmodule.c#L1821), [`chr()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Python/bltinmodule.c#L688), [`format()`](https://github.com/python/cpython/blob/d93605de7232da5e6a182fd1d5c220639e900159/Python/bltinmodule.c#L672), etc. are found within `Python/bltinmodule.c`.
...
The [`time` module](https://realpython.com/python-time-module/) is a good example. The way that Windows keeps and stores time in the Operating System is fundamentally different than Linux and macOS. This is one of the reasons why the accuracy of the clock functions differs [between operating systems](https://docs.python.org/3/library/time.html#time.clock_gettime_ns).
...
### The CPython Regression Test Suite[](#the-cpython-regression-test-suite "Permanent link")
...
### Installing a Custom Version[](#installing-a-custom-version "Permanent link")
...
The CPython Source Code: Conclusion[](#the-cpython-source-code-conclusion "Permanent link")
-------------------------------------------------------------------------------------------
...
The [official dev guide](https://devguide.python.org/) contains plenty of resources for beginners. You’ve already taken the first step, to understand the source, knowing how to change, compile, and test the CPython applications.
...
This might be a good time to learn more about Python and C. Who knows: you could be contributing more and more to the CPython project! Also be sure to check out the new [CPython Internals book](https://realpython.com/products/cpython-internals-book/) available here on Real Python:
...
[](https://realpython.com/feedback/survey/article/cpython-source-code-guide/liked/?from=article-footer "Liked it")[](https://realpython.com/feedback/survey/article/cpython-source-code-guide/disliked/?from=article-footer "Disliked it")
...
About **Anthony Shaw**
 ...
 [![Anthony Shaw](https://realpython.com/cdn-cgi/image/width=551,height=551,fit=crop,gravity=auto,format=auto/https://files.realpython.com/media/10995490_10152772557676353_1442757472697890998_n.e88e3d7b17c7.jpg)![Anthony Shaw](https://realpython.com/cdn-cgi/image/width=551,height=551,fit=crop,gravity=auto,format=auto/https://files.realpython.com/media/10995490_10152772557676353_1442757472697890998_n.e88e3d7b17c7.jpg)](https://realpython.com/team/ashaw/)
...
[» More about Anthony](https://realpython.com/team/ashaw/)
...
[![Jim Anderson](https://realpython.com/cdn-cgi/image/width=700,height=700,fit=crop,gravity=auto,format=auto/https://files.realpython.com/media/jima.0b8f990b951a.jpg)](https://realpython.com/team/janderson/)
...
[Level Up Your Python Skills »](https://realpython.com/account/join/?utm_source=rp_article_footer&utm_content=cpython-source-code-guide)
...
[](https://realpython.com/feedback/survey/article/cpython-source-code-guide/liked/?from=article-comments "Liked it")[](https://realpython.com/feedback/survey/article/cpython-source-code-guide/disliked/?from=article-comments "Disliked it")

[LinkedIn](https://www.linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Frealpython.com%2Fcpython-source-code-guide%2F) [Twitter](https://twitter.com/intent/tweet/?text=Interesting%20Python%20article%20on%20%40realpython%3A%20Your%20Guide%20to%20the%20CPython%20Source%20Code&url=https%3A%2F%2Frealpython.com%2Fcpython-source-code-guide%2F) [Bluesky](https://bsky.app/intent/compose?text=Interesting%20Python%20article%20on%20%40realpython.com%3A%20Your%20Guide%20to%20the%20CPython%20Source%20Code%20https%3A%2F%2Frealpython.com%2Fcpython-source-code-guide%2F) [Facebook](https://facebook.com/sharer/sharer.php?u=https%3A%2F%2Frealpython.com%2Fcpython-source-code-guide%2F) [Email](mailto:?subject=Python%20article%20for%20you&body=Your%20Guide%20to%20the%20CPython%20Source%20Code%20on%20Real%20Python%0A%0Ahttps%3A%2F%2Frealpython.com%2Fcpython-source-code-guide%2F%0A)
...
-   [Understand CPython](https://realpython.com/learning-paths/understand-cpython/?utm_source=realpython&utm_medium=web&utm_campaign=related-learning-path&utm_content=cpython-source-code-guide)

Related Tutorials:

-   [Dictionaries in Python](https://realpython.com/python-dicts/?utm_source=realpython&utm_medium=web&utm_campaign=related-post&utm_content=cpython-source-code-guide)
-   [What Is the Python Global Interpreter Lock (GIL)?](https://realpython.com/python-gil/?utm_source=realpython&utm_medium=web&utm_campaign=related-post&utm_content=cpython-source-code-guide)
-   [Python's asyncio: A Hands-On Walkthrough](https://realpython.com/async-io-python/?utm_source=realpython&utm_medium=web&utm_campaign=related-post&utm_content=cpython-source-code-guide)
-   [Python's property(): Add Managed Attributes to Your Classes](https://realpython.com/python-property/?utm_source=realpython&utm_medium=web&utm_campaign=related-post&utm_content=cpython-source-code-guide)
-   [Python enumerate(): Simplify Loops That Need Counters](https://realpython.com/python-enumerate/?utm_source=realpython&utm_medium=web&utm_campaign=related-post&utm_content=cpython-source-code-guide)

Keep reading Real Python by creating a free account or signing in:
------------------------------------------------------------------

[![Keep reading](https://realpython.com/static/videos/lesson-locked.f5105cfd26db.svg)](https://realpython.com/account/signup/?intent=continue_reading&utm_source=rp&utm_medium=web&utm_campaign=rwn&utm_content=v1&next=%2Fcpython-source-code-guide%2F)

[Continue »](https://realpython.com/account/signup/?intent=continue_reading&utm_source=rp&utm_medium=web&utm_campaign=rwn&utm_content=v1&next=%2Fcpython-source-code-guide%2F)

Already have an account? [Sign-In](https://realpython.com/account/login/?intent=continue_reading&next=/cpython-source-code-guide/)

Almost there! Complete this form and click the button below to gain instant access:

![CPython Internals: Your Guide to the Python 3 Interpreter](https://files.realpython.com/media/cpython-book-3d-shadow-trimmed.574c614751c3.png)
