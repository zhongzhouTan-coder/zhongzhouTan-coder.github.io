...
- [Harbor: Agent Evaluation Framework Design](../docs/frameworks/harbor-framework.md) — Why Harbor exists beyond Terminal-Bench, its task-centric design philosophy, `Job -> Trial -> Agent/Environment/Verifier` architecture, artifact and verifier isolation model, and the editable draw.io architecture asset.
